...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
  <link rel="shortcut icon" href="http://www.3g-dev.com/templates/gns_BTS_001/images/3gFavicon.ico" type="image/x-icon" />
...
<script> 
	...
	<body>
		...
		<div id="header_wrapper">
			...
			<div class="container_10" id="header_content" style="background: url(<?php echo base_url(); ?>assets/style/img/headerLogo.png) no-repeat left;">

				<h1 style="margin-left:45px;"><?php echo application_title(); ?></h1>
