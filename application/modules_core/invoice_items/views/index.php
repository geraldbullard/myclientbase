...
<div class="grid_7" id="content_wrapper">
	...
	<div class="section_wrapper">
		...
		<div class="content toggle no_padding">
			...
			<table>
				<tr>
					<th scope="col" class="first" style="width: 20%;"><?php echo $this->lang->line('id'); ?></th>
					<th scope="col" style="width: 20%;"><?php echo $this->lang->line('item'); ?></th>
					<th scope="col" style="width: 25%;"><?php echo $this->lang->line('description'); ?></th>
				...
				<tr>
					<td class="first"><?php echo $item->invoice_stored_item_id; ?></td>
					<td><?php echo $item->invoice_stored_item; ?></td>
					<td><?php echo $item->invoice_stored_item_description; ?></td>
