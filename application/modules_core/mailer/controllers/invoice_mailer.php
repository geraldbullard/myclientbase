    ...
    function form() {
        ...
        if (!$this->mdl_mailer->validate_invoice_email()) {
            ...
            if (!$_POST) {
                ...
                $this->mdl_invoices->set_form_value('email_to', $invoice->client_email_address);
                $this->mdl_invoices->set_form_value('email_from_name', $invoice->from_first_name . ' ' . $invoice->from_last_name);
                ...
                $this->mdl_invoices->set_form_value('email_body', '');
                $this->mdl_invoices->set_form_value('invoice_template', uri_assoc('invoice_template', 4));
