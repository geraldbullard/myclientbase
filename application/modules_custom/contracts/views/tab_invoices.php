<table style="width: 100%;">
		...
		<?php if (count($invoices)){
			...
			<tr>
				<td class="first"><a href="javascript:void(0)" class="invoice_history_link" id="invoice_history_link_<?php echo $invoice->invoice_id; ?>"><?php echo $invoice->invoice_id; ?></a></td>
				...
				<td class="last">
					<a href="<?php echo site_url('invoices/edit/invoice_id/' . $invoice->invoice_id . '/client_id/' . $invoice->client_id); ?>" title="<?php echo $this->lang->line('edit'); ?>">
						<?php echo icon('edit'); ?>
					</a>
					...
					<a href="<?php echo site_url('invoices/delete/invoice_id/' . $invoice->invoice_id . '/client_id/' . $invoice->client_id); ?>" title="<?php echo $this->lang->line('delete'); ?>" onclick="javascript:if(!confirm('<?php echo $this->lang->line('confirm_delete'); ?>')) return false">
...
<?php if (count($invoices)){ 
	if ($this->mdl_invoices->page_links) { ?>
		<div id="pagination">
